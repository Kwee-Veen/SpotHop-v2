...
const css = {
  ...
  map: '{"version":3,"file":"UserChart.svelte","sources":["UserChart.svelte"],"sourcesContent":["<script lang=\'ts\'>import { spotService } from \\"$lib/services/spot-service\\";\\nimport { currentSession } from \\"$lib/stores\\";\\nimport { onMount } from \\"svelte\\";\\nimport { Chart } from \\"svelte-echarts\\";\\nimport { get } from \\"svelte/store\\";\\nlet userList = [];\\nlet displayonlyspotcount = [];\\nlet userSpotCount = [];\\nlet options = {};\\nonMount(async () => {\\n  const userSpots = await spotService.getUserSpotCount(get(currentSession));\\n  userSpotCount = userSpots;\\n  displayonlyspotcount = userSpots;\\n  const users = await spotService.getUsers(get(currentSession));\\n  users.forEach((user) => {\\n    if (user.firstName && user.lastName) {\\n      let s = `${user.firstName} ${user.lastName}`;\\n      userList.push(s);\\n    }\\n  });\\n  start();\\n});\\nfunction start() {\\n  let setOptions = {\\n    tooltip: {\\n      trigger: \\"axis\\",\\n      axisPointer: {\\n        type: \\"shadow\\"\\n      }\\n    },\\n    grid: {\\n      left: \\"3%\\",\\n      right: \\"4%\\",\\n      bottom: \\"3%\\",\\n      top: \\"2%\\",\\n      containLabel: true\\n    },\\n    xAxis: [\\n      {\\n        type: \\"category\\",\\n        data: userList,\\n        axisTick: {\\n          alignWithLabel: true\\n        }\\n      }\\n    ],\\n    yAxis: [\\n      {\\n        type: \\"value\\"\\n      }\\n    ],\\n    series: [\\n      {\\n        name: \\"Direct\\",\\n        type: \\"bar\\",\\n        barWidth: \\"60%\\",\\n        data: userSpotCount\\n      }\\n    ]\\n  };\\n  options = setOptions;\\n}\\n<\/script>\\r\\n\\r\\n  <div class=\\"app\\">\\r\\n    <Chart {options} />\\r\\n  </div>\\r\\n  \\r\\n  <style>\\r\\n    .app {\\r\\n      width: 42.25vw;\\r\\n      height: 45vh;\\r\\n    }\\r\\n  </style>\\r\\n  "],"names":[],"mappings":"AAqEI,mBAAK,CACH,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,IACV"}'
};
...
const Charts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<br> <div class="columns is-mobile"><div class="column is-half"><div class="card"><div class="columns is-mobile" data-svelte-h="svelte-15exizn"><div class="column is-one-quarter"></div> <div class="column is-one-half"><div class="box has-background-danger-dark"><h4 class="text has-text-centered has-text-white">Spots by Category</h4></div></div> <div class="column is-one-quarter"></div></div> ${validate_component(CategoryChart, "CategoryChart").$$render($$result, {}, {}, {})}</div></div> <div class="column is-half"><div class="card"><div class="columns is-mobile" data-svelte-h="svelte-17orlel"><div class="column is-one-quarter"></div> <div class="column is-one-half"><div class="box has-background-link-dark"><h4 class="text has-text-centered has-text-white">Spots by User</h4></div></div> <div class="column is-one-quarter"></div></div> ${validate_component(UserChart, "UserChart").$$render($$result, {}, {}, {})}</div></div></div>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Charts, "Charts").$$render($$result, {}, {}, {})}`;
    }
  })} ${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(SpotList, "SpotList").$$render($$result, { spots }, {}, {})}`;
    }
  })}`;
});
export {
