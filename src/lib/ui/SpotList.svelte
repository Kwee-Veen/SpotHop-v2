    ...
    <div class="box has-background-success-light">
      <div class="columns is-centered">
        ...
        <div class="column is-3">
          {#if spot.img}
        <div class="box">
          <p class="text">{spot.img}</p>
        </div>
        {/if}

          <!-- Repeat Image Display -->
...
<!-- {#if spot.img}
              <div class="column is-3">
                <div class="box">
                  <b>Delete Image: </b>
                 <a href="/spot/{spot._id}/deleteimage" class="button"> -->
<!-- <span class="icon is-small">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 640 512"
...
<!-- <CldUploadWidget
          ...
          >
            <button class="button" on:click={open} disabled={isLoading}>
              Upload an Image
            </button>
          </CldUploadWidget> -->
<!-- {#if !spot.img}
        <div class="box">
          Not yet created, but would be the option to import a new image:
            <SpotImage {spot}/>
        </div>
      {/if} -->
<!-- </div> -->
